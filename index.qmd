...
The example we use throughout is the distribution of *Akodon montensis* (Rodentia, family Cricetidae), and a host or orthohantaviruses [@Burgos2021; @Owen2010], in Paraguay. We will collect data on known occurrences from GBIF [@GBIF:TheGlobalBiodiversityInformationFacility2025],
