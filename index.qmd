...
**Data, script, and code availability**: the package can be installed from the general _Julia_ registry; occurrence data for *Akodon montensis* are published by GBIF.org and available from `10.15468/dl.d3cxpr`; the code for all supplementary material is available from `10.5281/zenodo.15923830`. All of these resources can be accessed for free and anonymously.
